...
<script type="text/javascript">
  ...
  function cancelar()
  {
      ...
      {
          setTimeout("window.location='index-professor.php'", 0);
      }
...
$sql4 = "SELECT id_professor FROM professores WHERE login = '". $_SESSION['login'] . "' ;";
		      	...
		      	<div class="navbar-inner">
		        	<div class="container-fluid">
		          		...
		          		<div class="nav-collapse collapse">
		            		<ul class="nav">
		              			<li><a href="index-professor.php">Inicial</a></li>
        ...
        <div class="row-fluid">
            ...
            <div class="login-modal span6 text-right" style="margin-top:5px">
                ...
                echo "<h5>Olá, ".$_SESSION['login']."!</h5>";?>
                 ...
                 <a href="minha-conta.php?id=<?php echo $linhas6['id_professor'] ?>" role="button" class="btn btn-info"><i class="icon-cog icon-white"></i> Conta</a>
                <?php else:?>
            ...
            <div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    ...
                    <form class="form-horizontal span2" method="post" action="index-professor.php">
                        <div class="control-group">
                           <div class="controls">
                              </br>
                              </br>
