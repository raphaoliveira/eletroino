    ...
    if($q != '')
    {
       ...
       echo '<table class="table table-hover">';
        ...
        foreach($linhas as $linha) {
            ...
            ?>
            <td> <button type="button" onclick="window.location.href='alterar-professor.php?id=<?php echo $linha['id_professor'] ?>'">  Detalhar</button> </td>
            <?php
            ?>
            <td> <button type="button" onclick="window.location.href='excluir-professor.php?id=<?php echo $linha['id_professor'] ?>'">  Excluir</button> </td>
            <?php
            echo '<br>';
            echo '</tr>';
