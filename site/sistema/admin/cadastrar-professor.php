...
$sql = "SELECT login FROM professores";
...
<div class="row-fluid">
        <div class="span8">
            ...
            <form name="registroadmin" align="left" class="form-horizontal" method="post" action="tratar-cadastro-professor.php" id="registroadmin">
