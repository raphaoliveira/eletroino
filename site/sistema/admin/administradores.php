<?php include 'header-admin.php'; ?> 
    ...
    <form action="cadastrar-admin.php">
        <input type="submit" class="btn" value="Adicionar Admin">
    </form> 
    </div>
...
try {
    $sql = "SELECT * FROM administradores 
        ...
        foreach($linhas2 as $linha2) {
            ...
            ?>
            <td> 
                <button type="button" class="btn" onclick="window.location.href='alterar-admin.php?id=<?php echo $linha2['id_administrador'] ?>'">  Alterar</button>
            </td>
            <td> 
                 <button type="button" class="btn" onclick="window.location.href='excluir-admin.php?id=<?php echo $linha2['id_administrador'] ?>'">  Excluir</button>
            </td>
            <?php
            echo '</tr>';
